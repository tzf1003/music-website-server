...
/**
 * 
 * @TableName xs_history
 */
@TableName(value ="xs_history")
@Data
public class History implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getHisType() == null ? other.getHisType() == null : this.getHisType().equals(other.getHisType()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getHisType() == null) ? 0 : getHisType().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", hisType=").append(hisType);
